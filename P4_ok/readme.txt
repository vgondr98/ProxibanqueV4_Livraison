...
A) Téléchargement du dossier '/angular-pbv4': veuillez télécharger le dossier 
'angular-pbv4' sur votre pc.

B) Ouvrir l'invité de commande et veuillez vous placer sur le chemin d'accès 
de votre dossier où est situé le dossier à l'aide de la commande "cd" suivi
du chemin d'accès.
