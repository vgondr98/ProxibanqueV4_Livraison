 ...
 * - un num�ro de virement numVir,
 * - un Compte compte �metteur,
 * - un Compte compte cible,
 * - un libell�
 * - un Conseiller, le conseiller �tant � l'origine du virement.
 * Cette classe est une "entity class" et va permettre la persistence en base de donn�es d'un virement.
 */
@Entity
@Table(name = "VIREMENT")
@XmlRootElement
