...
/**
 * @author Victor 
 * La classe G�rant permet l'instanciation des objets G�rant avec comme attribut un IDGer (unique), un loginger (unique), 
 * un password (unique), un nom et un pr�nom, ainsi qu'une liste de Conseiller conseillerList, la liste de tous les conseillers sous sa responsabilit�.
 * Cette classe est une "entity class" et va permettre la persistence en base de donn�es d'un g�rant.
 */
@Entity
@Table(name = "GERANT")
@XmlRootElement
